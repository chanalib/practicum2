...
export class ApiClient {
     ...
     * @return Success
     */
    creatorAll(): Promise<Creator[]> {
        let url_ = this.baseUrl + "/api/Creator";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCreatorAll(_response);
        });
    }

    protected processCreatorAll(response: Response): Promise<Creator[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(Creator.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    creatorPOST(body: CreatorDTO | undefined): Promise<Creator> {
        let url_ = this.baseUrl + "/api/Creator";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCreatorPOST(_response);
        });
    }

    protected processCreatorPOST(response: Response): Promise<Creator> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    creatorGET(id: number): Promise<Creator> {
        let url_ = this.baseUrl + "/api/Creator/{id}";
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCreatorGET(_response);
        });
    }

    protected processCreatorGET(response: Response): Promise<Creator> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    creatorPUT(id: number, body: CreatorDTO | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/Creator/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCreatorPUT(_response);
        });
    }

    protected processCreatorPUT(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    creatorDELETE(id: number): Promise<void> {
        let url_ = this.baseUrl + "/api/Creator/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCreatorDELETE(_response);
        });
    }

    protected processCreatorDELETE(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    upload(contentType: string | undefined, contentDisposition: string | undefined, headers: { [key: string]: string[]; } | undefined, length: number | undefined, name: string | undefined, fileName: string | undefined): Promise<void> {
     ...
     * @return Success
     */
    byCreator(creatorId: number): Promise<void> {
        let url_ = this.baseUrl + "/api/s3/byCreator/{creatorId}";
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processByCreator(_response);
        });
    }

    protected processByCreator(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    presignedUrl(fileName: string | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/s3/presigned-url?";
        if (fileName === null)
            throw new Error("The parameter 'fileName' cannot be null.");
     ...
     * @return Success
     */
    byCreator2(creatorId: number): Promise<void> {
        let url_ = this.baseUrl + "/api/Song/byCreator/{creatorId}";
        if (creatorId === undefined || creatorId === null)
            throw new Error("The parameter 'creatorId' must be defined.");
        url_ = url_.replace("{creatorId}", encodeURIComponent("" + creatorId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processByCreator2(_response);
        });
    }

    protected processByCreator2(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class Song implements ISong {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.name = _data["name"];
            this.musicStyle = _data["musicStyle"];
            this.songLength = _data["songLength"] ? TimeSpan.fromJS(_data["songLength"]) : <any>undefined;
            this.releaseDate = _data["releaseDate"] ? new Date(_data["releaseDate"].toString()) : <any>undefined;
            this.imageUrl = _data["imageUrl"];
            this.creatorId = _data["creatorId"];
            this.creator = _data["creator"] ? Creator.fromJS(_data["creator"]) : <any>undefined;
    ...
    toJSON(data?: any) {
        ...
        data["id"] = this.id;
        data["name"] = this.name;
        data["musicStyle"] = this.musicStyle;
        data["songLength"] = this.songLength ? this.songLength.toJSON() : <any>undefined;
